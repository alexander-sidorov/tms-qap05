from hw.maria_saganovich.lesson6_hw.lvl5_duplicate_elements import func5_duplicate_elements
...
def test_func5_duplicate_elements() -> None:
    ...
    assert func5_duplicate_elements(c3) == {"errors": ["list shouldn't be empty"]}
